...
A Book class for a community library digitization system, built for Week 1 of CSC6301 (Automatic Code Documentation). It models a single library book, estimates reading time, formats a details summary, and validates status changes. An interactive terminal menu lets you exercise every method.

What it does

The Book class tracks four pieces of information for one book at a time: title, author, page count, and circulation status. Status is one of available, checked_out, or reserved.
...
└── shaun_clarke_csc6301/
    ...
    ├── library_book.py     Source code (Book class and interactive menu)
...
bashpython3 -m pydoc -w library_book
